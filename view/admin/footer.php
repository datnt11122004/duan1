                ...
                <div class="form-box">
                    <div class="form-tab">
                        <ul class="nav nav-pills nav-fill" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="forgotpassword-tab-2" data-toggle="tab" href="#forgotpassword-2" role="tab" aria-controls="forgotpassword-2" aria-selected="false">forgotpassword</a>
                            </li>
                        </ul>
